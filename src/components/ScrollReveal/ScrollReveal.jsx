...
const ScrollReveal = ({
    ...
    const variants = useMemo(
        () => ({
            ...
            "fade-up": {
                from: { opacity: 0, y: offset, z: 0 },
                to: { opacity: 1, y: 0, z: 0 },
            },
            "fade-down": {
                from: { opacity: 0, y: -offset, z: 0 },
                to: { opacity: 1, y: 0, z: 0 },
            ...
            "fade-left": {
                from: { opacity: 0, x: -offset, z: 0 },
                to: { opacity: 1, x: 0, z: 0 },
            },
            "fade-right": {
                from: { opacity: 0, x: offset, z: 0 },
                to: { opacity: 1, x: 0, z: 0 },
            ...
            "zoom-in": {
                from: { opacity: 0, scale: 0, z: 0 },
                to: { opacity: 1, scale: 1, z: 0 },
            },
            "zoom-out": {
                from: { opacity: 0, scale: 1.2, z: 0 },
                to: { opacity: 1, scale: 1, z: 0 },
            },
            "clip-fade-up": {
                from: {
    ...
    useLayoutEffect(() => {
        if (!loadGsap || !internalRef.current) return;
